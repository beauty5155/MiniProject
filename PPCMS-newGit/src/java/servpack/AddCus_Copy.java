 ...
 */
@WebServlet(urlPatterns = {"/AddCus_Copy"})
public class AddCus_Copy extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            conn = DriverManager.getConnection("jdbc:mariadb://localhost:3307/ppcms_db", "root", "");
            String sql1 = "", sql2 = "";
